      ...
      >
        ...
        <div className=" hidden md:flex flex-row justify-between text-3xl w-screen px-5  pb-[0px]  ">
          ...
          <div
            className={classNames(
              scroll
                ? "bg-[#fde047]  rounded-md hover:bg-white !text-black px-5 "
                : "",
              nav,
            )}
          >
        ...
        >
          {!navMenu ? (
            ...
            <span className="material-icons z-20 text-white ">close</span>
          )}
        </div>
      </div>
      <div>
        ...
        >
          ...
          <li
            className={classNames(
              scroll
                ? "bg-[#fde047] text-black rounded-md hover:bg-white hover:text-black px-5 "
                : "",
              "px-5 py-3 border-b border-gray-500 hover:bg-[#fbbf24]",
            )}
          >
            Commander
          </li>
